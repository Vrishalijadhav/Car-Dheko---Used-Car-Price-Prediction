...
def extract_details(row):
    try:
        print(f"Processing row: {row.get('car_links', 'unknown')}")  # Debug print
        ...
        print("Extracted detail:", detail)  # Debug print
        print("Extracted overview:", overview)  # Debug print
        print("Extracted features:", features)  # Debug print
        print("Extracted specs:", specs)  # Debug print
...
def normalize_numerical_features(df):
    numerical_columns = ['km_driven', 'price', 'manufacturing_year', 'registration_year', 'Mileage']
    
    # Print original values for debugging
    print("Original numerical features before scaling:\n", df[numerical_columns])
...
def convert_to_structured_format(file_path, city_name, output_dir):
    ...
    structured_df = normalize_numerical_features(structured_df)
